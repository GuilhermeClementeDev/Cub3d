...
/*   Updated: 2025/10/27 17:58:30 by guclemen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_raycast(t_game *g, int x)
{
	...
	g->ray.ray_dir_x = g->map_game.player.dir_x + g->map_game.player.plane_x * g->ray.camera_x;
	g->ray.ray_dir_y = g->map_game.player.dir_y + g->map_game.player.plane_y * g->ray.camera_x;
